    ...
    <div className="min-h-screen bg-bg text-text selection:bg-primary/30">
      ...
      <nav className="container mx-auto px-6 py-8 flex items-center justify-between sticky top-0 z-50 glass border-none rounded-b-3xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/register">
            <Button variant="primary" className="font-bold shadow-2xl">
              Get Started
            </Button>
          </Link>
        </div>
          ...
          <AnimatePresence mode="wait">
            {role ? (
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
                    Welcome back,{" "}
                    <span className="text-gradient capitalize">{role}</span>.
                  </h1>
                  <p className="text-xl text-textMuted max-w-2xl mx-auto font-medium">
                    {role === "doctor" &&
                      "You have 8 patients scheduled for today. Ready to start your shift?"}
                    {role === "patient" &&
                      "Your health journey continues. Check your latest records or book a new appointment."}
                    {role === "admin" &&
                      "System health is optimal. 4 new users are pending verification."}
                  </p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    ...
                    >
                      <Button
                        size="lg"
                        className="w-full sm:w-auto text-lg px-10 rounded-2xl group"
                        variant="primary"
                      >
                        Go to Dashboard{" "}
              ...
              >
                ...
                >
                  MedCloud provides a seamless experience for patients, doctors,
                  and administrators. Streamline appointments, manage records,
                ...
                >
                  <Link href="/register" className="w-full sm:w-auto">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto text-lg px-12 rounded-2xl h-16 shadow-2xl shadow-primary/30"
                      variant="primary"
                    >
                      Start as Patient
                    </Button>
                  ...
                  <Link href="/login" className="w-full sm:w-auto">
                    <Button
                      variant="glass"
                      size="lg"
                      className="w-full sm:w-auto text-lg px-12 rounded-2xl h-16 border-2"
                    >
                      Portal Login
                    </Button>
                  </Link>
      ...
      <footer className="border-t border-border/50 py-16 bg-surface/30 backdrop-blur-md">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-textMuted text-sm font-medium">
            © 2026 MedCloud HMS. Built for the future of healthcare.
          </p>
