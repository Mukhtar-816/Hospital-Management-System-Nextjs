...
export default function AdminDashboard() {
  ...
  const appointmentStatusData = analytics.appointmentsByStatus.map(
    (item: any) => ({
    ...
    >
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-textMuted mt-1 font-medium italic">
              System performance is at{" "}
              <span className="text-success font-black">99.8%</span> capacity.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {mainStats.map((stat, index) => (
          <motion.div key={stat.label} variants={itemVariants}>
            <Card
              hoverable
              className="relative group border-none glass overflow-hidden"
            >
              <div
                className={cn(
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div
                  className={cn(
                    "flex items-center gap-1 text-[10px] font-black px-2 py-1 rounded-lg bg-surface border border-border shadow-sm",
              ...
              <div>
                <p className="text-xs font-black text-textMuted uppercase tracking-widest">
                  {stat.label}
                </p>
          ...
          <Card title="User Demographics" className="h-full glass border-none">
            <div className="h-[300px] mt-4 relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
                ...
                <p className="text-[10px] text-textMuted uppercase font-black mt-1">
                  Total
                </p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <motion.div variants={itemVariants}>
          <Card
            title="Recent Activity Hub"
            className="glass border-none h-full"
          >
            <div className="space-y-4 mt-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-4 p-4 rounded-2xl bg-surface/50 border border-border/50 hover:border-primary/20 transition-all cursor-pointer group"
                >
                  ...
                  <ChevronRight
                    size={14}
                    className="text-textMuted opacity-0 group-hover:opacity-100 transition-opacity"
                  />
                </div>
              ))}
            </div>
