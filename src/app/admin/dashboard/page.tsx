  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-textMuted">System-wide overview and user management.</p>
      </div>
        ...
        <Card title="System Health" subtitle="Server and database status">
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 rounded-xl bg-success/10 border border-success/20">
              <span className="text-sm font-medium text-success">Database Connection</span>
              <span className="text-xs font-bold text-success uppercase">Connected</span>
            </div>
            <div className="flex items-center justify-between p-3 rounded-xl bg-success/10 border border-success/20">
              <span className="text-sm font-medium text-success">Auth Service</span>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-warning/10 border border-warning/20">
              ...
              <span className="text-xs font-bold text-warning uppercase">Monitor</span>
            </div>
          </div>
        </Card>
        ...
        <Card title="Recent Registrations" subtitle="Newly joined users">
          <div className="space-y-4">
            {recentUsers.map((user) => (
              <div key={user.userid} className="flex items-center gap-4 p-3 rounded-xl border border-border">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-text">{user.useremail}</p>
                </div>
